...
server.get('/jqueryIndex.js',(req,res)=>{
    res.setHeader('content-type','application/javascript');
    res.sendFile(fullPath+'/javaScript/jqueryIndex.js');
});

server.get('/jqueryWelcome.js',(req,res)=>{
    res.setHeader('content-type','application/javascript');
    res.sendFile(fullPath+'/javaScript/jqueryWelcome.js');
});
